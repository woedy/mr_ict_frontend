            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/all-my-courses"
                  className={({ isActive }) =>
                    `group relative flex items-center gap-2.5 rounded-sm py-2 mt-10 px-4 font-medium ${
                      isActive
                        ? 'bg-primary text-white dark:bg-meta-4 dark:text-white'
                        : 'text-black hover:bg-bodydark1 hover:text-black dark:text-bodydark1 dark:hover:bg-meta-4'
                    } duration-300 ease-in-out `
              ...
              <li>  
                <NavLink
                  to="/settings"
                  className={({ isActive }) =>
                    `group relative flex items-center gap-2.5 rounded-sm py-2 px-4  mt-10 font-medium ${
                      isActive
                  ...
                  className={({ isActive }) =>
                    `group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium ${
                      isActive
                        ...
                        : 'text-black hover:bg-bodydark1 hover:text-black dark:text-bodydark1 dark:hover:bg-meta-4'
                    } duration-300 ease-in-out mt-15`
                  }
                >
                  <svg
                    className="fill-current"
